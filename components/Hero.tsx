    ...
    <>
      ...
      <div className="text-center relative z-10 max-w-6xl mx-auto px-4 pt-8">
        <div className="flex justify-center mb-8">
            <img src="/logo.svg" alt="Bring Any Idea to Life Logo" className="w-16 h-16 md:w-20 md:h-20" />
        </div>
        ...
        <p className="text-base sm:text-xl text-zinc-400 max-w-3xl mx-auto leading-relaxed font-light">
          Gemini sees the potential in everything. Describe an idea, drop in a diagram, or upload a photo, and watch it turn into an interactive app or a cinematic video.
        </p>
      </div>
    </>
  );
